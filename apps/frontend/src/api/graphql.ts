...
export type CreateTenantUserMutation = { __typename?: 'Mutation', createTenantUser: { __typename?: 'User', id: string, tenantId?: string | null, role: Role, username: string, tenant?: { __typename?: 'Tenant', id: string, name: string } | null } };
